...
client = mqttClient.Client("ZunoMonitorv1010")  # create new instance
...
try:
    while True:
        mycursor = mydb.cursor()
        mycursor.execute("SELECT * FROM Monitor")
        ...
        while myresult is not None:
            ...
            #print(payload)
            ret = client.publish("Pyrios/Monitor/Device/1001", payload)  # topic-v1/devices/me/telemetry
            myresult = mycursor.fetchone()
